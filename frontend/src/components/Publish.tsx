  ...
  return (
    <div className='flex flex-col items-center gap-3'>
      ...
      <textarea
        ...
        rows={1}
        className='w-1/2 block p-2.5 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 placeholder:text-center placeholder:text-sm'
        placeholder='Title'
      ></textarea>
      <TextEditor
        onChange={(e) => {
      ...
      <button
        ...
        type='submit'
        className='inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded focus:ring-4 focus:ring-blue-200 hover:bg-blue-800'
      >
        Publish post
      </button>
    </div>
